document.getElementById('verdatos').onclick = function (){
    visibleDatos = document.getElementById('datos');
    if (visibleDatos.style.display === 'inline'){
    document.getElementById('datos').style.display = 'none';
    document.getElementById("verdatos").innerHTML="Ver datos personales";
    }
    else{
        document.getElementById('datos').style.display = 'inline';
        document.getElementById("verdatos").innerHTML="Ocultar";
    }

}

document.getElementById('verProyectos').onclick = function(){
    visible1 = document.getElementById('proyectos');
    if (visible1.style.display === 'inline'){
    document.getElementById('proyectos').style.display = 'none';
    document.getElementById("verProyectos").innerHTML="Ver proyectos";
    }
    else{
        document.getElementById('proyectos').style.display = 'inline';
        document.getElementById("verProyectos").innerHTML="Ocultar";
    }
